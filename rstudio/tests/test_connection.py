...
container = client.containers.run(os.environ['IMAGE_NAME'], ports={'8787/tcp': 8787}, detach=True)
time.sleep(20)
container.reload()
...
def test_rstudio_access():
    rstudio_url = "http://{}:8787".format(container.attrs["NetworkSettings"]["Networks"]["bridge"]["IPAddress"])
