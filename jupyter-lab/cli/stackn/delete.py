...
from .stackn import delete_app, delete_meta_resource, delete_object, delete_project
...
def delete_env(name, project, studio_url, secure):
    delete_meta_resource(
        "environments", name, project=project, studio_url=studio_url, secure=secure
    )
...
def delete_obj(name, version, studio_url, project, secure):
    delete_object(
        name, version=version, studio_url=studio_url, project=project, secure=secure
    )
